					...
					for ($i=1; $i<=$st_vrstic; $i++) {
						if (isset($_GET["razvrsti"]) && isset($_GET["od"]) && isset($_GET["do"]) && isset($_GET["nacin"])) {
							if (isset($_GET["stran"]) && $i == $_GET["stran"]) {
								?><a href="zacetna_isci_kategorija.php?kategorija=<?php echo $_GET["kategorija"]; ?>&stran=<?php echo $i; ?>&razvrsti=<?php echo $_GET["razvrsti"]; ?>&od=<?php echo $_GET["od"]; ?>&do=<?php echo $_GET["do"]; ?>&nacin=<?php echo $_GET["nacin"]; ?>"><button class="btn btn-danger btn-sm" style="width: 30px; margin-left: 2px; margin-right: 2px;"><?php echo $i.' '; ?></button></a><?php
							}
							else {
								?><a href="zacetna_isci_kategorija.php?kategorija=<?php echo $_GET["kategorija"]; ?>&stran=<?php echo $i; ?>&razvrsti=<?php echo $_GET["razvrsti"]; ?>&od=<?php echo $_GET["od"]; ?>&do=<?php echo $_GET["do"]; ?>&nacin=<?php echo $_GET["nacin"]; ?>"><button class="btn btn-dark btn-sm" style="width: 26px; margin-left: 2px; margin-right: 2px;"><?php echo $i.' '; ?></button></a><?php
							}
						}
						else if (!isset($_GET["razvrsti"]) && !isset($_GET["od"]) && !isset($_GET["do"]) && !isset($_GET["nacin"])) {
							if (isset($_GET["stran"]) && $i == $_GET["stran"]) {
								?><a href="zacetna_isci_kategorija.php?kategorija=<?php echo $_GET["kategorija"]; ?>&stran=<?php echo $i; ?>"><button class="btn btn-danger btn-sm" style="width: 30px; margin-left: 2px; margin-right: 2px;"><?php echo $i.' '; ?></button></a><?php
							}
							else {
								?><a href="zacetna_isci_kategorija.php?kategorija=<?php echo $_GET["kategorija"]; ?>&stran=<?php echo $i; ?>"><button class="btn btn-dark btn-sm" style="width: 26px; margin-left: 2px; margin-right: 2px;"><?php echo $i.' '; ?></button></a><?php
							}
						}
					}
				?>
